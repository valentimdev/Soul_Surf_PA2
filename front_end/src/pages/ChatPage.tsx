            ...
            <div className="flex-1 overflow-y-auto px-4 py-6 max-w-4xl w-full mx-auto">
                <div className="space-y-0">
                    {allMessages.map((m, idx) => {
                        ...
                        const marginTop = prev && prev.senderId === m.senderId ? "mt-1" : "mt-4";

                        return (
                            <div
                                key={m.id}
                                className={`flex ${isMine ? "justify-start" : "justify-end"} items-end ${marginTop}`}
                            >
                                <div
                    ...
                    ${isMine
                                ...
                                >
                                    ...
                                    <p className={`text-xs mt-1 ${isMine ? "text-slate-400" : "text-indigo-100"}`}>
