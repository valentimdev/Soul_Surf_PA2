...
public class UserController {
    ...
    public ResponseEntity<MessageResponse> followUser(
            @Parameter(description = "ID do usuário a ser seguido") @PathVariable Long id,
            @AuthenticationPrincipal UserDetailsImpl userDetails) {
    ...
    public ResponseEntity<MessageResponse> unfollowUser(
            @Parameter(description = "ID do usuário a ser deixado de seguir") @PathVariable Long id,
            @AuthenticationPrincipal UserDetailsImpl userDetails) {
    ...
    public ResponseEntity<UserDTO> updateUserProfileWithFiles(
        ...
        UserDTO updatedUserDTO = userService.updateUserProfileWithFiles(userDetails.getId(), username, bio, fotoPerfil,
                fotoCapa);
