...
import com.soulsurf.backend.modules.admin.dto.AdminPeriodMetricsDTO;
import com.soulsurf.backend.modules.beach.dto.PostsByBeachDTO;
import com.soulsurf.backend.modules.admin.dto.TopAuthorDTO;
...
public class AdminMetricsService {
    ...
    public AdminPeriodMetricsDTO getPeriodMetrics(LocalDateTime start, LocalDateTime end) {
        ...
        dto.setActiveUsersCount(postRepository
                .topAuthorsBetween(start, end, org.springframework.data.domain.PageRequest.of(0, Integer.MAX_VALUE))
                .size());
        return dto;
    }

    public List<TopAuthorDTO> getTopAuthors(LocalDateTime start, LocalDateTime end, int limit) {
        var rows = postRepository.topAuthorsBetween(start, end,
