...
public class PostController {
    ...
    @PostMapping
    public ResponseEntity<?> createPost(@Parameter(description = "Título do post") @RequestParam("titulo") String titulo,
    ...
    @Operation(summary = "Busca um post pelo ID", description = "Retorna os detalhes de um único post.")
